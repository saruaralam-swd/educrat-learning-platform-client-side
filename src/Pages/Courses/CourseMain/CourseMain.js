...
import { FaUserFriends, FaCalendar, FaBusinessTime } from 'react-icons/fa';
        ...
        <img src={img} className="h-[350px] hidden lg:block" alt="course img" />
          ...
          <div className='space-y-5'>
            ...
            <div className='bg-gray-200 h-[75px] text-right'>
              <button className='border-2 border-violet-500 outline-1 hover:bg-violet-500 px-4 py-1 rounded-md transition duration-500 mt-5 mr-4'><Link to={`/courses/${id}`}>See Details</Link></button>
            </div>
          </div>
